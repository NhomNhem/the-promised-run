...
namespace OpenUtility.Editor
{
    ...
    public class ExtendedDropdown
    {
        ...
        private class Dropdown : AdvancedDropdown
        {
            ...
            /// </summary>
            public event Action<int, ExtendedDropdownItem> OnClick;
            ...
            protected override void ItemSelected(AdvancedDropdownItem item)
            {
                ...
                if (_dropdownItems.ContainsKey(key))
                {
                    ...
                    dropdownItem.clicked?.Invoke(dropdownItem.data);

                    int number = key * -1;
                    OnClick?.Invoke(number, dropdownItem);
                }
            }
        ...
        /// in the list of extended dropdown items.
        /// </summary>
        public event Action<int, object> OnClick;
        ...
        /// </summary>
        private void OnItemClicked(int numberOfItem, ExtendedDropdownItem item)
        {
            OnClick?.Invoke(numberOfItem, item.data);
        }
